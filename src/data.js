  ...
  EN: [
    {
      ...
      issuance: 'Issuance: 10/2021',
      expiration: 'Expiration: No expiration',
      link: 'https://v2.credential.net/64fb8441-1b9a-4c44-85dc-51b3639d14ed#gs.f49lp4',
      company: 'Trybe',
    },
    {img: WiseUp,
      name: 'Wise Up English Course',
      issuance: 'Issuance: 10/2021',
      expiration: 'Expiration: No expiration',
      link: 'https://bit.ly/3lYVYJp',
      company: 'Wise Up',
    },
    {
      img: Trybe, name: 'Web Development Fundamentals',
      issuance: 'Issuance: 07/2021',
      expiration: 'Expiration: No expiration',
      link: 'https://v2.credential.net/0a53b87f-7162-4084-9884-4a641c171862#gs.e5xeh5',
      company: 'Trybe',
    },
  ],
  PT: [
    {
      ...
      issuance: 'Emissão: 10/2021',
      expiration: 'Expiração: Sem expiração',
      link: 'https://v2.credential.net/64fb8441-1b9a-4c44-85dc-51b3639d14ed#gs.f49lp4',
      company: 'Trybe',
    },
    {
      img: WiseUp,
      name: 'Curso de Inglês Wise Up',
      issuance: 'Emissão: 10/2021',
      expiration: 'Expiração: Sem expiração',
      link: 'https://bit.ly/3lYVYJp',
      company: 'Wise Up',
