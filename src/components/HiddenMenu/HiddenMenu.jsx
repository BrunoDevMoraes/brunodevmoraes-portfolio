  ...
  if (language === 'PT') {
    return (
      <div id="hidden-menu" className={theme === 'dark' ? 'dark-hidden-menu' : 'light-hidden-menu'}>
        <a href="#redirect-about" onClick={handleHiddenClick}>
        <div className={theme === 'dark' ? 'dark-option' : 'light-option'}><h4>Sobre mim</h4></div>
        </a>
        <a href="#redirect-abilities" className={theme === 'dark' ? 'dark-option' : 'light-option'} onClick={handleHiddenClick}>
          <div className={theme === 'dark' ? 'dark-option' : 'light-option'}><h4>Habilidades</h4></div>
        </a>
        <a href="#redirect-projects" className={theme === 'dark' ? 'dark-option' : 'light-option'} onClick={handleHiddenClick}>
          <div className={theme === 'dark' ? 'dark-option' : 'light-option'}><h4>Projetos</h4></div>
        </a>
        <a href="#redirect-certifications" className={theme === 'dark' ? 'dark-option' : 'light-option'} onClick={handleHiddenClick}>
