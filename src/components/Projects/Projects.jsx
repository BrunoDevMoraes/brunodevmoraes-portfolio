    ...
    <div id="projects-section">
      {window.innerWidth <= 800 ? (
        <>
          ...
          <div id="cards-selection">
            <button onClick={handleBackClick}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-arrow-left-circle" viewBox="0 0 16 16" fill="#ED6112">
                <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8zm15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-4.5-.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
              </svg>
            </button>
            {renderProjectCard()}
            <button onClick={handleNextClick}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-arrow-right-circle" viewBox="0 0 16 16" fill="#ED6112">
        ...
        <>
          ...
          : <h3 id="projects-section-title">My Projects</h3>}
          {language === 'PT' ? (
            <div id="projects-row">{data.PT.map((project) => <ProjectCard project={project}/>)}</div>
          ) : (
            <div id="projects-row">{data.EN.map((project) => <ProjectCard project={project}/>)}</div>
          )}
        </>
      )}
    </div>
